					...
					<tr class="woocommerce-cart-form__cart-item <?php echo esc_attr( apply_filters( 'woocommerce_cart_item_class', 'cart_item', $cart_item, $cart_item_key ) ); ?>">
						...
						<td class="product-name" data-title="<?php esc_attr_e( 'Product', 'woocommerce' ); ?>">
							<?php
								...
								// var_dump($cart_item);
								$variationData = get_post_meta($cart_item['variation_id']);

								if($cart_item['product_id'] == 1405) {

									echo '<br/><strong>Thickness</strong><br/>'.$variationData['attribute_thickness'][0].'<br/>';
									echo '<strong>Dimensions</strong><br/>'.$variationData['_height'][0].'mm(H) x ';
									echo $variationData['_width'][0].'mm(W) x ';
									echo $variationData['_length'][0].'mm(L)<br/>';
						...
						<td class="product-quantity" data-title="<?php esc_attr_e( 'Quantity', 'woocommerce' ); ?>"><?php
							...
							} else if ($cart_item['product_id'] == 1405) {
								$product_quantity = $cart_item['quantity'] . '<input type="hidden" name="cart[{' . $cart_item_key . '}][qty]" value=" ' . $cart_item['quantity']. '" />';
							} else {
